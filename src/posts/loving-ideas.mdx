...
[Abdul](https://abdulhdr.com) and I scheduled a meeting with a startup [founder](https://x.com/coproduto) whom we admire a lot to talk about [Mind](https://getmind.app). In this meeting, we got a lot of ideas and asked for feedback about what we’re building and what we could do better. 
<br/>
...
- Finally launched the v1 for my [bookmarks tool](https://bookmarks.gustavofior.com), heavily inspired by [Rauno’s](https://bmrks.com) and without a proper name yet. If you have suggestions, feel free to reach me :)
