...
I’m primarly Java developer, who's been working with Spring for more that 2 years now, and in the last few months I started a [project](https://mind.abdulhdr.com/) where I'm learning/coding in a whole new stack. Trying this new toys made me realize how much time I waste to execute the same task with two different set of tools.
