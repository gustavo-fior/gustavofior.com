      ...
      {isOpen && (
        ...
        >
          ...
          <button
            ...
            className={`flex w-fit select-none items-center gap-[5px] text-[12px]  tracking-[0.01em] text-orange-500 transition-opacity hover:opacity-70 ${
          ...
          <button
            ...
            className={`flex w-fit select-none items-center gap-[5px] text-[12px]  tracking-[0.01em] text-sky-500 transition-opacity hover:opacity-70 ${
          ...
          <button
            ...
            className={`flex w-fit select-none items-center gap-[5px] text-[12px]  tracking-[0.01em] text-amber-500 transition-opacity hover:opacity-70 ${
          ...
          <button
            ...
            className={`flex w-fit select-none items-center gap-[5px] text-[12px]  tracking-[0.01em] text-red-500 transition-opacity hover:opacity-70 ${
          ...
          <button
            ...
            className={`flex w-fit select-none items-center gap-[5px] text-[12px]  tracking-[0.01em] text-pink-500 transition-opacity hover:opacity-70 ${
