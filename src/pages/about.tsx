...
import LinkText from "~/components/Linkable";
        ...
        <div className="flex w-[40rem] flex-col">
          ...
          <div className="text-lg text-slate-300">
            <p className="pb-4">
              ...
              <LinkText link="https://bancosb.com.br">SB Cash</LinkText>. This
            ...
            <ul className="list-disc pl-8">
              ...
              <li>
                Kafka (
                <LinkText link="https://developer.confluent.io/learn/kraft/">
                  KRaft
                </LinkText>
                )
              </li>
            ...
            <p>
              ...
              TypeScript, and <LinkText link="https://expo.dev">Expo</LinkText>.
            </p>
            <br />
            <p>
              Besides that, I&apos;m also co-founder of a startup called{" "}
              <LinkText link="https://getmind.app">Mind</LinkText>, where me and
              my friend <LinkText link="https://abdulhdr.com">Abdul</LinkText>{" "}
              are building an app to make going to therapy a lot easier.
            </p>
            <br />
            <p>
              I keep a record of{" "}
              <LinkText link="https://gustavofior.notion.site/Cool-Stuff-f4f54a6fe8fe4bc1bc34c588966fb631?pvs=4">
                cool stuff
              </LinkText>{" "}
            ...
            <p>
              ...
              <LinkText link="https://cal.com/gustavo-fior">schedule</LinkText>{" "}
            ...
            <div className="rounded-lg bg-white bg-opacity-20 px-6 py-4 drop-shadow-lg backdrop-blur-lg">
              ...
              <p className="italic">
                Herman Hesse,{" "}
                <LinkText link="https://en.wikipedia.org/wiki/Demian">
                  Demian
                </LinkText>
              </p>
            </div>
